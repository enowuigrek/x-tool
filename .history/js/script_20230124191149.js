...
//BUTTONS
const skuListButton = document.getElementById('generate_sku_button');
const skuLinkButton = document.getElementById('generate_list_button');
...
const orderLinkButton = document.getElementById('generate_order_link_button');
