...
const generateSkuFromLinks = () => {
  ...
  console.log(typeof(splitInputTextArray[foundXKomIndex+1]))
  const skuFromText =  + 'https://www.x-kom.pl/p/' + splitInputTextArray[foundXKomIndex+1]

  console.log(skuFromText);
  splitInputTextArray.push(skuFromText);
