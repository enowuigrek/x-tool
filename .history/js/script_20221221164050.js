...
const generateSkuFromLinks = () => {
  ...
  const xKomInText = (phraseBeforeSku) => {
  ...
  for (let pieceOfInputText of splitInputTextArray) {
    ...
    if (pieceOfInputText === 'x-kom:') { xKomInText(pieceOfInputText)
      ...
      if (pieceOfInputText === 'xkom:') xKomInText(pieceOfInputText)
      if       if (pieceOfInputText === 'xkom:') xKomInText(pieceOfInputText)


    if (pieceOfInputText.includes('https://www.x-kom.pl/p/')) {
        let skuFromInputLink = skuFromLink.exec(pieceOfInputText)[1];
