...
const generateSkuFromLinks = () => {
  ...
  const extractorSkuFromLink = (linkXkom) => {
  ...
  for (let pieceOfInputText of splitInputTextArray) {
    ...
    if (pieceOfInputText === 'dupa') skuFinder(pieceOfInputText);
    if (pieceOfInputText.includes('https://www.x-kom.pl/p/')) extractorSkuFromLink(pieceOfInputText);
  }
