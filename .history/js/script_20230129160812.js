...
//Clear Buttons
const clearSkuInputButton = document.etElementById('clear_sku');
const clearMessageInputButton = document.etElementById('clear_message');
const clearOrderInputButton = document.etElementById('clear_order');
...
clearSkuInputButton.addEventListener('click', clearInput);
