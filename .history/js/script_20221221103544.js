...
//BUTTONS
const generationSkuButton = document.querySelector('.generation__sku_button');
...
//RESULTS
const displaySkuToCopy = document.querySelector('.sku_to__copy');
...
const generateSkuFromLinks = () => {
  ...
  //TODO: Rozkminić wycinanie z tekstu, żeby pentla nie nadpisywała poprzedniego wyszukania.
  ...
  console.log(pieceOfInputText);
    ...
    if (pieceOfInputText.includes('found-')) {
      ...
      pieceOfInputText.replace('found-', '') // TODO: Metoda do sprawdzenia, powinno być OK.
      console.log(pieceOfInputText);
