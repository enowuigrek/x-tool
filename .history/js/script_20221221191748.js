...
const generateSkuFromLinks = () => {
  ...
  for (let pieceOfInputText of splitInputTextArray) {
    ...
    // switch(pieceOfInputText) {
    //   case 'x-kom:' : skuFinder(pieceOfInputText);
    //   case 'xkom:': skuFinder(pieceOfInputText);
    //   case 'sku:': skuFinder(pieceOfInputText);
    //   case 'sku': skuFinder(pieceOfInputText);
    // }


    if (pieceOfInputText === 'x-kom:' || pieceOfInputText === 'xkom:' || pieceOfInputText === 'sku:' || pieceOfInputText === 'sku:' ||) skuFinder(pieceOfInputText);
