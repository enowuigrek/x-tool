...
const generationLinkFromLinksButton = document.getElementById(
...
generationSkuFromMessageButton.addEventListener('click', generateSkuFromLinks);
generationLinkFromMessageButton.addEventListener('click', generateSkuFromLinks);
