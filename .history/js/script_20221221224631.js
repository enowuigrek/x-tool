...
const inputxKomOrderNumber = document.querySelector('.input_x-kom_order_number');
const inputAlToOrderNumber = document.querySelector('.input_al.to_order_number');
...
const generateOrderLink = () => {
  ...
  const linkBeginAlTo = 'https://xkom-prod.operations.dynamics.com/?cmp=xkom&mi=SalesTableDetails&SalesId=';
