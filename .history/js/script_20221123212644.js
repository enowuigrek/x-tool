...
function generateSku() {
  ...
  const pastedSplitLink = pastedLinks.split(/\r?\n/)
  console.log(pastedSplitLink);

  for ( let singleLink of https://www.x-kom.pl/p/1070690-smartfon-telefon-xiaomi-redmi-a1-2-32gb-light-blue.html)

  const skuFromPastedLinks = skuFromProductLinkMatcher.exec(pastedSplitLink)[1];
