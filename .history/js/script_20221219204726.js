...
const generateSkuFromLinks = () => {
  ...
  for (let pieceOfInputText of splitInputTeod: Green Cell|kod producenta: PBGC03|kod x-kom: 575269
    od: Green Cell|kod producenta: PBGC03|kod x-kom: 575269
    xtArray) {

    if (pieceOfInputText.includes('https://www.x-kom.pl/p/')) {

      const skuFromInputText = skuFromLink.exec(pieceOfInputText)[1];
