...
const skuListFromMessageButton = document.getElementById('sku_list_from_message_button');
const skuLinkFromMessageButton = document.getElementById('sku_link_from_message_button');
const orderLinkButton = document.getElementById('order_link_button');

const clearButton = document.getElementById('order_link_button');


//Results
const displaySkuToCopy = document.querySelector('.sku_to_copy');
const displaySkuToCopyFromLinks = document.querySelector('.sku_to_copy_from_links');
...
const displaySkuListLinkMessage = () => {
  ...
  delateDuplicateAndUndefined();
  linkToList(listSkuArr);
  displaySkuToCopyFromLinks.innerHTML = resultLink;
};
