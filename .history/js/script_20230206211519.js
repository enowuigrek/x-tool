...
const copySku = () => {
  // var copyText = document.getElementById('sku_from_input');
  let toCopy = resultSkuFromInput.innerHTML
  // resultSkuFromInput.select()
  // resultSkuFromInput.setSelectionRange(0, 99999)
  console.log('button działa');
  resultSkuFromInput.innerHTML.execCommand('copy');
}
