...
const copySku = () => {
  ...
  if (resultSkuFromInput.innerHTML != 'Wklej sku oddzielone spacją lub enterem' && resultSkuFromInput.innerHTML != 'Lista na stronie') {
...
if (resultSkuFromInput.innerHTML == '') {
  ...
  copyButton.classList.add('no-display');
}
