...
const dispaySkuToCopyFromLinks = document.querySelector(
...
const generateSkuFromLinks = () => {
  ...
  for (let pieceOfInputText of splitInputTextArray) {
    ...
    if (pieceOfInputText.startsWith("https://www.x-kom.pl/p/")) {
      console.log(skuFromProductLinkMatcher.exec(pieceOfInputText));

      const skuFrominputText =
        skuFromProductLinkMatcher.exec(pieceOfInputText)[1];
