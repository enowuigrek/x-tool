...
const resultOrder = document.getElementById('order_link');
...
const displayOrderLink = () => {
  ...
  if (orderNumber.length === 12) {
    ...
    if (linkBegin == undefined) {
      resultOrder.innerHTML = 'To nie jest numer zamówienia';
    } else {
      const resultOrderHref = `<a href= ${orderLink} target="_blank"> ${orderNumber} </a>`;
      resultOrder.innerHTML = resultOrderHref;
    }
  } else if (orderNumber == '') {
