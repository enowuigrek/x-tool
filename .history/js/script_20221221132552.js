...
const generationSkuFromMessagesButton = document.querySelector(
  '.generation_sku_from_messages_button'
);
...
const displaySkuToCopyFromMessagess = document.querySelector(
  '.sku_to_copy_from_Messagess'
);
...
const generateSkuFromMessages = () => {
  ...
  for (let singleSku of listSku) {
    ...
    resultSkuToCopyFromMessages += listElementSku;
  }
  displaySkuToCopyFromMessages.innerHTML = resultSkuToCopyFromMessages;
};
...
generationSkuFromLinksButton.addEventListener('click', generateSkuFromMessages);
